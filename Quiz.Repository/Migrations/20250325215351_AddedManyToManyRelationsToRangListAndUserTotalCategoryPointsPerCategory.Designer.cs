...
namespace Quiz.Repository.Migrations
{
    ...
    [Migration("20250325215351_AddedManyToManyRelationsToRangListAndUserTotalCategoryPointsPerCategory")]
    partial class AddedManyToManyRelationsToRangListAndUserTotalCategoryPointsPerCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quiz.Domain.Domain_Models.EventPending_User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Quiz.Domain.Domain_Models.RangList_TotalPointsPerCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("UserTotalPointsPerCategoryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserTotalPointsPerCategoryId");

                    b.ToTable("RangList_TotalPointsPerCategories");
                });

            modelBuilder.Entity("Quiz.Domain.Domain_Models.RangList_User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RangList_Users");
                });

            modelBuilder.Entity("Quiz.Domain.Domain_Models.TypeQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Quiz.Domain.Domain_Models.Question", b =>
                {
                    ...
                    b.HasOne("Quiz.Domain.Domain_Models.TypeQuestion", "TypeQuestion")
                        .WithMany("QuestionList")
                        .HasForeignKey("TypeQuestionId");

                    b.Navigation("Quiz");

                    b.Navigation("TypeQuestion");
                });
            ...
            modelBuilder.Entity("Quiz.Domain.Domain_Models.RangList_TotalPointsPerCategory", b =>
                {
                    ...
                    b.HasOne("Quiz.Domain.Domain_Models.UserTotalPointsPerCategory", "UserTotalPointsPerCategory")
                        .WithMany()
                        .HasForeignKey("UserTotalPointsPerCategoryId");
            ...
            modelBuilder.Entity("Quiz.Domain.Domain_Models.Event", b =>
                {
                    b.Navigation("EventPending_User");
